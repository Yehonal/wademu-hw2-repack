...
prune_unused_accounts_days=60 #If the account isn't used for more than this amount of days, then it is removed. Set to 0 to disable.
...
prune_leq_level=2 #All characters whose levels are below this will be removed. Set to 0 to disable.
