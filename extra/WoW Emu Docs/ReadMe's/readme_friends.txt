...
- You need "_Cmd.tcl" and "-Custom.tcl" from the Honor System that can be found here:
  http://catvir.wgc-eden.com/phpBB2/viewtopic.php?t=98
...
http://catvir.wgc-eden.com/phpBB2/viewtopic.php?t=671
