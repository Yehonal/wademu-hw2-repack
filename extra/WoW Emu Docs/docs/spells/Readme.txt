...
The Team: Flame ,Wolfahrt, Pinhow, TgNd, Chinonet, n0sf3ratu, Raverouk, Atavera, LordLeech, Radeon, Seatleson, Zombie and big thanks to all that help this project....


LAST UPDATE by Seatleson on 06.04.2006
=======================================

06.04.2006 by Seatleson and tested by Seatleson 
Reducted mana/hp recovering amount due to incorrect cooldown

+ Healing Potions (reducted healing amount to 1/2)
- Combat Healing Potion & Superior Healing Potion
- Discolored Healing Potion & Lesser Healing Potion
- Greater Healing Potion
- Healing Potion
- Major Healing Potion
- Minor Healing Potion

+ Healthstones (Warlock) (reducted healing amount to 1/3)
- Healthstone
- Greater Healthstone
- Lesser Healthstone
- Minor Healthstone
...
+ Mana Stones (Mage) (reducted recovering amount to 1/3)
- Mana Agate
- Mana Citrine
- Mana Jade
- Mana Ruby
...
06.04.2006 by Seatleson and tested by Seatleson 
These spells now heal only allies:
...
06.04.2006 by Seatleson and tested by Seatleson 
This spell now damages only enemies
...
06.04.2006 by Seatleson and tested by Seatleson 
Corrected problem of the following spells that affected Manaburn's cooldown
...
04.04.2006 by BAD and partially tested by BAD(too bussy)

//Professions(lvl req as on official):
- Alchemy
- Blacksmithing
- Enchanting
- Engineering
...
For Apprentice need lvl 5
For Journeyman need lvl 10
For Expert need lvl 20
For Artisan need lvl 35


P.S If I will have time I will make also the skill req as on official..

Also, I hope soon to correct and adapted the new prices for professions..


04.04.2006 by Artemis and partially tested by BAD(too bussy)

//Correct Melee Attack, no more "Too Far Away"

Now the melee range is 5 yards...Increased radius attack


04.04.2006 by X-Pirs and partially tested by BAD(too bussy)

//AntiLogout 

- No more full hp when logout in combat..


11.03.2006 by BAD and partially tested by BAD(too bussy)

Paladin
---------

Paladin can only use one seal per him:
...
Paladin can only use one blessing per him:
- Blessing Of Might
...
Hunter can use only one sting per battle:
- Serpent Sting
- Scorpid Sting
- Wyvern Sting
- Viper Sting
...
P.S Aspects have been fixed in previous release


warlock the changes was made by BAD and Nihilx 
--------

Warlock can use only one curse per battle:
- Curse of Weakness
- Curse of Agony
...
02.03.2006 by Zombie and not tested by BAD(too bussy)

P.S I dont have time to write down all the changes and I will make a short brief:

Paladin now can only use only one aura per him
Hunter now can only use only one aspect per him

More spell fixed(taming system and stealth....) ...Later when I will have time I will post the list...



P.S Me(BAD) I'm too bussy now and therefore others or my team will continue this project for a while...I will comeback later and I will try to make the changes from emulator not from spell.dbc(Was my method but are better ones and I hope soon to find the way)...
