...
They allow players to enter the queues for Warsong Gulch.

Alliance (creatures 2302, 14981, 14982):
questscript=Warsong::Battle
npcflags=03
faction=1514

Horde (creatures 2804, 3890, 10360):
questscript=Warsong::Battle
npcflags=03
faction=1515

They should be placed in capital cities. Check http://wow.allakhazam.com/ for more information.


	2. Spirit guides

They resurrect players at the graveyards.
...
They give a repeatable quest that allows players to gain reputation.
...
Modifiy quests:
8291, 7873, 7872, 7871, 7788: deliver=19213 3
8294, 7876, 7875, 7874, 7789: deliver=19322 3

Modifify quests 8291 and 9294 to give -1xp (because the original 0 actually gives 250xp).
...
To play a game, players have to join a queue by either touching the entrance portal to Warsong Gulch, or by talking to a Warsong Gulch Battlemaster in capital cities.
...
(Those are the default queues, you can configure the number of queues and the levels in the configuration file.)
...
The winners will automatically get their rewards (talismans of merit/mark of honor).
Winners get 3 marks of honor/talismans of merit. Losers get 1 only if the game lasted at least 10 minutes.
