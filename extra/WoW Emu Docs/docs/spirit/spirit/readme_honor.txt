...
pub=
  ...
  You need to install the addon to have notifications and information about honor in the character and inspect panel.
...
The recommended way to deal with load order is to use the StartTCL System, available on CatVir's forum.
If you are using a StartTCL version lower than v0.9.0, you need to change the load level for "Custom.tcl" from "a" to "c".
 ...
 *** Upgrade from versions before v4.30 ***

 Upgrade the files like normal, but make sure you delete -Custom.tcl and _Cmd.tcl. those files have been merged into Custom.tcl.
...
- Use simple and fast AI::CanAgro/CanUnAgro and WoWEmu::DamageReduction procedures.
